...
<?php endif;?>
		<div id="filter-bar" class="btn-toolbar">
			<div class="filter-search btn-group pull-left">
				...
				<input type="text" name="filter_search" id="filter_search" placeholder="<?php echo JText::_('COM_JCKMAN_SEARCH_IN_TOOLBAR_TITLE'); ?>" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" title="<?php echo JText::_('COM_JCKMAN_SEARCH_IN_TOOLBAR_TITLE'); ?>" />
			</div>
			...
			<thead>
				<tr>
					...
					<th width="10%" class="nowrap hidden-phone">
						<?php echo JHTML::_('grid.sort', JText::_('COM_JCK_LAYOUT_MANAGER_NAME'), 't.name', $listDirn, $listOrder ); ?>
					</th>
