...
(function() {
  ...
  CKEDITOR.plugins.add(PLUGIN_NAME, {
    ...
    beforeInit: function(editor) {
		...
		CKEDITOR.plugins.undo.Image = function( editor )
		{
			this.editor = editor;
  ...
  function init(editor) {
    ...
    Resizer.prototype = {
      ...
      showHandles: function() {
		...
		this.el.className = this.el.className.replace(' cke-resize', ''); //clear any cke-resize classes
